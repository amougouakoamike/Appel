...
<body>
        <!--  header start-->
          <header class="heading">
            <a href="#home" class="logo"><img src="iphone-1 (8).jpg" alt="" width="90px" ></a>
...
<section class="home" id="home">
      ...
      <div class="swiper-wrapper wrapper">
        <div class="swiper-slide slide">
          <div class="content">
            ...
            <p>Come inspecte our products, you will never regrettte. We are waiting for you</p>
            <a href="#iphone" class="btn">Order now</a>
          </div>
          <div class="image">
            <img src="iphone-1 (31).jpg" alt="">
          </div>
        </div>
        <div class="swiper-slide slide">
          <div class="content">
            ...
            <h3>Mac Book</h3>
            <p>Come inspecte our products, you will never regrettte. We are waiting for you</p>
            <a href="mac-book.php" class="btn">Order now</a>
          </div>
          <div class="image">
            <img src="iphone-1 (16).jpg" alt="">
          </div>
        </div>
        <div class="swiper-slide slide">
          <div class="content">
            ...
            <h3>EarPots</h3>
            <p>Come inspecte our products, you will never regrettte. We are waiting for you</p>
            <a href="hear-pot.php" class="btn">Order now</a>
          </div>
          <div class="image">
            <img src="iphone-1 (4).jpg" alt="">
          </div>
        </div>
 ...
 <section class="about" id="about">
  <div class="swiper2 about-slider">
    <div class="swiper-wrapper wrapper">
      <div class="swiper-slide slider">
        <div class="content">
          <span>About Us & Services</span>
          <h3> Personalized Shopping Assistance</h3>
          <p>Offering personalized recommendations based on customer preferences and purchase history can significantly enhance the shopping experience.</p>
        </div>
        <div class="image">
          <img src="iphone-1 (31).jpg" alt="">
        </div>
      ...
      <div class="swiper-slide slider">
        <div class="content">
          <span>About Us & Services</span>
          <h3> Flexible Return Policies</h3>
          <p>A hassle-free return policy builds trust and encourages customers to make purchases without fear of being stuck with unwanted items.</p>
        </div>
        <div class="image">
          <img src="iphone-1 (16).jpg" alt="">
        </div>
      ...
      <div class="swiper-slide slider">
        <div class="content">
          ...
          <p>Offering multiple delivery options, including same-day or next-day delivery, can greatly enhance customer satisfaction.</p>
        </div>
        <div class="image">
          <img src="iphone-1 (4).jpg" alt="">
        </div>
